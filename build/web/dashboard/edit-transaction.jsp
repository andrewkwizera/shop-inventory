            ...
            <div class="row justify-content-center">
                ...
                <div class="col">
                    <div class="card shadow my-3">
                        <div class="card-header bg-secondary text-white">Edit Transaction</div>
                        <div class="card-body">
                            <form action="./update-transaction.jsp" method="post">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="product" id="product" class="form-control" required="required">
                                            <option value="<%= transaction.getProduct().getId()%>"><%= transaction.getProduct().getName() %></option>
                                            <%
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="type" id="transaction" class="form-control" required="required">
                                            <option value="<%= transaction.getType() %>"><%= transaction.getType() %></option>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="description" rows="2" class="form-control" required="required"><%= transaction.getDescription() %></textarea>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="quantity" class="col-sm-3 col-form-label">Quantity</label>
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" name="quantity" required="required" value="<%= transaction.getQuantity() %>"/>
                                    </div>
                                </div>
