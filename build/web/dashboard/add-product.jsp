            ...
            <div class="row justify-content-center">
                ...
                <div class="col">
                    <div class="card shadow my-3">
                        ...
                        <div class="card-body">
                            <form action="./save-product.jsp" method="post">
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" min="0" class="form-control" name="buying_price" required="required"/><label class="text-danger"><%=model.getSellMsg() %></label>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="selling_price" class="col-sm-3 col-form-label">Selling Price</label>
                                    <div class="col-sm-9">
                                        <input type="number" min="0" class="form-control" name="selling_price" required="required"/>
                                    </div>
                                </div>
                                <div class="mb-3 row">
